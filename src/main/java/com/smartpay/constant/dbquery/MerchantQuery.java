...
public class MerchantQuery {
	...
	public static final String UPDATE_BANK_ONBOARD_STATUS="UPDATE Merchant m SET m.bankOnboardStatus=:bankOnboardStatus WHERE m.userName=:userName AND m.isActive=:activeStatus";
}
